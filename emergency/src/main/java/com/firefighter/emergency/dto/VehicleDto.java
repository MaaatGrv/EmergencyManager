...
public class VehicleDto {
	...
	public VehicleDto(int id, double lon, double lat, com.firefighter.emergency.dto.VehicleType type,
			com.firefighter.emergency.dto.LiquidType liquidType, float liquidQuantity, float fuel,
